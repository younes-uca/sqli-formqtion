...
public class ClientCategoryRestAdmin  extends AbstractController<ClientCategory, ClientCategoryDto, ClientCategoryCriteria, ClientCategoryAdminService, ClientCategoryConverter> {
    ...
    @Operation(summary = "Finds a clientCategory by libelle")
    @GetMapping("libelle/{libelle}")
    public ResponseEntity<ClientCategoryDto> findByLibelle(@PathVariable String libelle, String[] includes, String[] excludes) throws Exception {
        return super.findByReferenceEntity(new ClientCategory(libelle), includes, excludes);
    }
