package ma.sqli.formation.zynerator.converter;


import ma.sqli.formation.zynerator.bean.Etablissement;
import ma.sqli.formation.zynerator.dto.EtablissementDto;

import ma.sqli.formation.zynerator.util.ListUtil;
import ma.sqli.formation.zynerator.audit.AuditBusinessObject;
import ma.sqli.formation.zynerator.bean.BusinessObject;
import ma.sqli.formation.zynerator.dto.AuditBaseDto;
import ma.sqli.formation.zynerator.dto.BaseDto;
import ma.sqli.formation.zynerator.util.DateUtil;
import ma.sqli.formation.zynerator.util.RefelexivityUtil;
import ma.sqli.formation.zynerator.util.StringUtil;
import ma.sqli.formation.zynerator.util.Utils;
